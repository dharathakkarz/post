...
//   <Card key={index} sx={{ minWidth: 275, margin: '10px', position: 'relative' }}>
//     {/* Edit icon */}
//     <EditIcon sx={{ position: 'absolute', top: 5, right: 40, cursor: 'pointer' }} />
//     <DeleteIcon sx={{ position: 'absolute', top: 5, right: 5, cursor: 'pointer' }}  />
//     <CardContent>
...
// export default CreatePost; // working 
...
//         <Card key={index} sx={{ minWidth: 275, margin: '10px', position: 'relative' }}>
//           {/* Edit icon */}
//           <EditIcon color='primary'  sx={{ position: 'absolute', top: 5, right: 40, cursor: 'pointer' , }} />
   
//           <DeleteIcon color='primary' sx={{ position: 'absolute', top: 5, right: 5, cursor: 'pointer' }} onClick={() => handleDelete(index)} />
//           <CardContent>
//             <Typography variant="h5" component="div">
//               Title: {post.title}
//             </Typography>
...
// export default CreatePost; // with delete -without redux 
